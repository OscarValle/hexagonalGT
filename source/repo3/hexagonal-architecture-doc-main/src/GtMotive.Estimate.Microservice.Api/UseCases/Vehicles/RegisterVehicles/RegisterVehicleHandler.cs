...
{
    public class RegisterVehicleHandler(IRegisterVehicleUseCase useCase, IRegisterVehicleOutputPort presenter) : IRequestHandler<RegisterVehicleRequest, IWebApiPresenter>
    {
        public async Task<IWebApiPresenter> Handle(RegisterVehicleRequest request, CancellationToken cancellationToken)
        {
            ...
            return (RegisterVehiclePresenter)presenter;
        }
    }
}
